...
## Data (assets/sda-hymns/hymns.json)

The project now uses a single JSON file instead of an SQLite DB: `/Users/e/dev/GitHub/isda-pptgen/assets/sda-hymns/hymns.json`. The file is generated by the provided migration script (`migrate_to_json.py`) from the previous tables.
